...
public class vowelAdapter extends BaseAdapter {
    ...
    public vowelAdapter(Context context, ArrayList<com.bananakernel.banglasignlanguage.model.model> models) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if(view == null)
        {
            view = View.inflate(context, R.layout.vowel_items , null);
        }

        ImageView images = view.findViewById(R.id.vowelImageView);
        TextView title = view.findViewById(R.id.vowelTextView);
