...
public class consonantAdapter extends BaseAdapter {
    ...
    public consonantAdapter(Context context, ArrayList<com.bananakernel.banglasignlanguage.model.model> models) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if(view == null)
        {
            view = View.inflate(context, R.layout.consonant_items , null);
        }

        ImageView images = view.findViewById(R.id.consonantImageView);
        TextView title = view.findViewById(R.id.consonantTextView);
